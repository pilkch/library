...
library/src
library/lib
Include required files from the library, add any required lib files to the project and compile

Credit:
This library is created mostly by Christopher Pilkington.  
I use a few other people's libraries as well for which I am eternally grateful.  
...
I use quite a few libraries, so if I missed anyone please contact me and they will be added right away.  
