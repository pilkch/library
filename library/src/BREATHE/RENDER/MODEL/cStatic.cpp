...
namespace BREATHE
{
	namespace MODEL
	{
		...
		/////// * /////////// * /////////// * NEW * /////// * /////////// * /////////// *
			...
			else if(frustum->CubeInFrustum(pNode->m_vCenter.x, pNode->m_vCenter.y, 
		...
		/////// * /////////// * /////////// * NEW * /////// * /////////// * /////////// *
			...
			if(pNode->IsSubDivided())
			{
				...
				render(pNode->m_pOctreeNodes[TOP_LEFT_FRONT]);
				render(pNode->m_pOctreeNodes[TOP_LEFT_BACK]);
				render(pNode->m_pOctreeNodes[TOP_RIGHT_BACK]);
				render(pNode->m_pOctreeNodes[TOP_RIGHT_FRONT]);
				render(pNode->m_pOctreeNodes[BOTTOM_LEFT_FRONT]);
				render(pNode->m_pOctreeNodes[BOTTOM_LEFT_BACK]);
				render(pNode->m_pOctreeNodes[BOTTOM_RIGHT_BACK]);
				render(pNode->m_pOctreeNodes[BOTTOM_RIGHT_FRONT]);
			}
			else
			{
