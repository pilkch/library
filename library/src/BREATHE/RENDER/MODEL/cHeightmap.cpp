...
#include <BREATHE/MODEL/cHeightmapPatch.h>
#include <BREATHE/MODEL/cHeightmap.h>
...
namespace BREATHE
{
	namespace MODEL
	{
		...
		void cHeightmap::Reset()
		{
			...
			//
			int eyeX = (int)(cHeightmap::pFrustum->eye.x - PATCH_SIZE * sinf( cHeightmap::pFrustum->look.z * MATH::cPI_DIV_180 ));
			int eyeY = (int)(cHeightmap::pFrustum->eye.z + PATCH_SIZE * cosf( cHeightmap::pFrustum->look.z * MATH::cPI_DIV_180 ));

			int leftX  = (int)(eyeX + 100.0f * sinf( (cHeightmap::pFrustum->look.z-cHeightmap::pFrustum->fov) * MATH::cPI_DIV_180 ));
			int leftY  = (int)(eyeY - 100.0f * cosf( (cHeightmap::pFrustum->look.z-cHeightmap::pFrustum->fov) * MATH::cPI_DIV_180 ));

			int rightX = (int)(eyeX + 100.0f * sinf( (cHeightmap::pFrustum->look.z+cHeightmap::pFrustum->fov) * MATH::cPI_DIV_180 ));
			int rightY = (int)(eyeY - 100.0f * cosf( (cHeightmap::pFrustum->look.z+cHeightmap::pFrustum->fov) * MATH::cPI_DIV_180 ));
