...
namespace BREATHE
{
	...
	// vPathOut = empty;
	// return false;
	bool cPathGraph::GetPath(const cPathNode* pNodeBegin, const cPathNode* pNodeEnd, path_list& lPathOut)
	{
		lPathOut.clear();
	...
	// vPathOut = empty;
	// return false;
	bool cPathGraph::GetPath(const MATH::cVec3& v3Begin, const MATH::cVec3& v3End, path_list& lPathOut)
	{
		lPathOut.clear();
