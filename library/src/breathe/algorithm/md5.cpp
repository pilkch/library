...
namespace breathe
{
	...
	void cMD5::Finish( cMD5_Context *ctx)
	{
		...
		PUT_UINT32( ctx->state[0], result,  0 );
		PUT_UINT32( ctx->state[1], result,  4 );
		PUT_UINT32( ctx->state[2], result,  8 );
		PUT_UINT32( ctx->state[3], result, 12 );
		...
		t << static_cast < unsigned short > (result[2]);
		t << static_cast < unsigned short > (result[3]);
		t << static_cast < unsigned short > (result[4]);
		t << static_cast < unsigned short > (result[5]);
		t << static_cast < unsigned short > (result[6]);
		t << static_cast < unsigned short > (result[7]);
		t << static_cast < unsigned short > (result[8]);
		t << static_cast < unsigned short > (result[9]);
		t << static_cast < unsigned short > (result[10]);
		t << static_cast < unsigned short > (result[11]);
		t << static_cast < unsigned short > (result[12]);
