...
#if !defined(BUILD_LIBOPENGLMM_WINDOW_SDL) && !defined(BUILD_LIBOPENGLMM_WINDOW_GTKGLEXT)
#error "BUILD_LIBOPENGLMM_WINDOW_SDL or BUILD_LIBOPENGLMM_WINDOW_GTKGLEXT must be defined"
#endif
