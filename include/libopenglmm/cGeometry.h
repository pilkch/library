...
namespace opengl
{
  ...
  {
  private:
    void CreatePlane(std::vector<float>& vertices, std::vector<float>& normals);
    void CreatePlane(std::vector<float>& vertices, std::vector<float>& normals, std::vector<float>& textureCoords, size_t nTextureUnits);
    void CreateBox(std::vector<float>& vertices, std::vector<float>& normals);
    void CreateBox(std::vector<float>& vertices, std::vector<float>& normals, std::vector<float>& textureCoords, size_t nTextureUnits);
  };
}
