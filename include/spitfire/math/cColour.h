...
namespace spitfire
{
  namespace math
  {
    ...
    public:
      ...
      cColour3 GetComplimentary() const; // Gets the matching complimentary colour
    ...
    public:
      ...
      cColour4 GetComplimentary() const; // Gets the matching complimentary colour
    ...
    public:
      ...
      void ShiftHue(float fDegrees); // Shift the hue by this amount
